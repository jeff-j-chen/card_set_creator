# Given an existing dets.txt file (generated by hard_negative_creator):
# filter out bad points, reorder them, and use a min-area rectangle as the bounding box (as opposed to my hand-drawn polygons)
# and generate images for the nitin_fullset folder (for detection)
